...
async function handle_query(input_url) {
    ...
    engine.queryBindings(`SELECT ?v WHERE {
      ?movie a <http://www.w3.org/ns/ldp#BasicContainer> ;
          <http://www.w3.org/ns/ldp#contains> ?v. 
      }`, {
        sources: [input_url],
        ...
        bindingsStream.on('end', function () {
            ...
            engine.queryBindings(`SELECT ?name ?image WHERE {?movie <https://schema.org/name> ?name.
